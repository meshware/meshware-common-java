package io.meshware.common.event.jbus;

import io.joyrpc.extension.Extension;
import io.meshware.common.concurrent.Daemon;
import io.meshware.common.event.*;
...
public class JEventBus implements EventBus {
    ...
    protected static class JPublisher<E extends Event> implements Publisher<E> {
        ...
        protected final Map<EventHandler<E>, EventHandler<E>> handlerMap = new ConcurrentHashMap<>();
        /**
         * 消费者
         */
        ...
        protected void publish(final E event) {
            if (event != null) {
                ...
                for (EventHandler<E> handler : handlerMap.values()) {
                    handler.handle(event);
                }
            }
        }
